...
set -A MSG2 85 115 105 110 103 32 71 84 75 45 115 101 114 118 101 114 32 119 105 116 104 32 71 116 107 71 108 69 120 116 33
...
define AVAIL gtk "gtk_server_require libgtkglext-x11-1.0.so"
if [[ $AVAIL != "ok" ]]
then
